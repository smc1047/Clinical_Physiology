...
Our focus on establishing the RMP in the sarcolemma will be on the roles played by concentration and electrical gradients created by Na, K and Cl. Each of these elemental molecules exist in the body as ions (they carry a charge based on whether the have too many electrons (Cl) or two few electrons (Na, K). Ca is an ion that has 2 more protons than electrons (hence the 2+ superscript in its abbreviation). 

\subsubsection{Electrical Potentials \& Equilibrium Potential}

When an ion moves across a membrane it carries a charge across the membrane and creates an electrical potential. 

%%% Left off here on June 6th at 6 am
