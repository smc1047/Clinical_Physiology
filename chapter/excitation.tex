...
An excitable membrane is polarized in its resting state, the resting membrane potential. It is excitable because with a stimulus it can be depolarized. 
It is important to recognize that the membrane cannot depolarize unless it is first polarized. Understanding how the RMP is established, how the RMP depolarizes with an action potential (AP), and how the AP spreads is necessary for a deeper understanding of muscle excitation including how various clinical situations may influence excitation.
