...
\begin{enumerate}
    ...
    \item
    \item
    \item Explain how smooth muscle works with internal organs and passageways through the body 
    \item Explain how smooth muscles differ from skeletal muscles 
    \item Explain the difference between single-unit and multi-unit smooth muscle
\end{enumerate}
...
% left off here
Intra cellular edema is when there is increased fluid in the intra cellular space (which is distributed in all cells). There are several situations that can cause intra cellular edema. There are four situations conditions that can cause intracellular edema.
\begin{enumerate}
    \item Hyponatremia (reduces ECF osmolarity)
