...
% Add a link to a Tachyarrhythmia YouTube playlist
...
% Add a links to a Bradyarrhythmia &  Block Youtube Playlist
...
% Add a ST Changes YouTube Playlist
...
BP of the upper extremity should be measured in the following manner:
\begin{enumerate}
