...
\chapter{Micro-Circulation}\label{chp:microcirculation}
Updated on \today
\minitoc
...
There are several processes involved with the regulation of ECF acid base balance (pH). Each is presented in the upcoming chapters such as buffers in the blood and through filtration in the kidneys (Chapter \ref{chp:filtration_reabsorption_secretion}, and respiration Chapter \ref{chp:respiration}).
